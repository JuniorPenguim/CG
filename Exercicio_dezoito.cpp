...
void display(void)
{
    ...
    if(object == 1)
    {
        ...
        //Secao sobre a parametrizacao do cilindro
        ...
        //definindo a textura referente aos 2 circulos do cilindro
        textureManager->Bind(5);

        //parte referenfe ao circulo da parte de cima do cilindro
        glBegin(GL_TRIANGLE_FAN);//pequenos triangulos que fecham um circulo
        ...
        // parte referente ao circulo da parte de baixo do cilindo. O for esta em ordem inversa
        ...
        //definindo a textura referente ao corpo do cilindro
        textureManager->Bind(4);

        // corpo do cilindro, feito usando um quadrado
