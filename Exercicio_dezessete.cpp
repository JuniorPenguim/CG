...
void display(void)
{
    ...
    if(object == 1)
    {
        ...
        //Tudo foi feito usando apenas 1 face, apenas foram criadas todas as 6 faces do cubo
        // e a forma de aplicação de textura foi igual a usada no exemplo pronto.
